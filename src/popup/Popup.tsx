...
import {QuizCode} from '../options/modules/SettingsTab/TextSettings'
...
export const CodeInput = (props: TextBoxInputProps) => {
  return (
    <div className="mt-10 flex justify-center gap-2">
      <QuizCode placeHolder={'Quiz Code'} />
      <button
...
export const Popup = () => {
  const [firstLaunchOver, setFirstLaunchOver] =
    useSyncedState('firstLaunchOver')

  useEffect(() => {
    console.log('FIRST = ', firstLaunchOver)
  }, [firstLaunchOver])
  ...
  return (
    <div className="bg-mui-gold  pt-1">
      <div className="  border-mui-gold bg-gradient-to-tl from-mui-blue-dark to-mui-blue p-4">
        ...
        <TempAccessList />
        {!firstLaunchOver ? (
          <CodeInput onChange={val => setFirstLaunchOver(val)} />
        ) : (
          <div className="mt-10 flex justify-center gap-2">
            <button
